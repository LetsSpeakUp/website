...
function JoinUs({}: Props) {
  return (
    <div>
      <h1 className="text-5xl font-semibold text-center p-8 text-black dark:text-gray-100 bg-gray-50 dark:bg-[#151515] tracking-widest">Join Us</h1>
        ...
        <div className="p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <div className="mt-4 md:mt-8">
              <a
                href="#"
                className="inline-block rounded bg-yellow-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-yellow-700 focus:outline-none focus:ring focus:ring-gray-100"
              >
                Get Started
              </a>
            </div>
